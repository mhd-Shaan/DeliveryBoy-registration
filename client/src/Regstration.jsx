...
const MultiStepForm = () => {
  ...
  const sendOtp = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/registration`, {
        name: formData.name,
  ...
  const submitLicenseInfo = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/finalregistration`, data, {
        ...
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
          ...
          {activeStep === steps.length ? (
            <Box textAlign="center" py={4}>
              ...
              <Typography color="textSecondary">Redirecting to login...</Typography>
            </Box>
          ) : (
            <>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 4 }}>
                ...
                <Button onClick={handleNext} variant="contained" disabled={loading} endIcon={loading ? <CircularProgress size={20} /> : <NextIcon />}>
              ...
              <Box sx={{ textAlign: 'center', mt: 3 }}>
                <Typography variant="body2" color="textSecondary">
                  ...
                  <Button component={Link} to="/login" variant="text" sx={{ fontWeight: 600, textTransform: 'none' }}>
                    Login
                  </Button>
                </Typography>
              </Box>
